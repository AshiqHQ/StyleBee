...
<section class="shop-checkout container">
    ...
    <div class="cart-table__wrapper">
        ...
        @foreach ($items as $item)            
            ...
            <td>
                <span class="shopping-cart__subtotal">BDT: {{ $item->subTotal() }}</span>
            </td>
            <td>
    ...
    <div class="shopping-cart__totals-wrapper">
        ...
        <div class="shopping-cart__totals">
            ...
            <tbody>
                ...
                <tr>
                <th>Total</th>
                <td>BDT: {{ Cart::instance('cart')->total() }}</td>
                </tr>
            </tbody>
            </table>
        </div>
        <div class="mobile_fixed-btn_wrapper">
            ...
            <a href="{{ route('cart.checkout') }}" class="btn btn-primary btn-checkout">CHECKOUT FOR COD</a>
            </div>
            <br>
            <div class="button-wrapper container">
            <a href="{{ route('exampleEasycheckout') }}" class="btn btn-primary btn-checkout">PAY ONLINE</a>
            </div>
        </div>
        </div>
    </div>
