...
<section class="shop-main container d-flex pt-4 pt-xl-5">
    ...
    <div class="accordion" id="price-filters">
        ...
        <div id="accordion-filter-price" class="accordion-collapse collapse show border-0"
            ...
            data-slider-max="10000" data-slider-step="5" data-slider-value="[{{ $min_price }},{{ $max_price }}]" data-currency="BDT" />
            <div class="price-range__info d-flex align-items-center mt-2">
            <div class="me-auto">
                <span class="text-secondary">Min Price: </span>
                <span class="price-range__min">BDT: {{ $min_price }}</span>
            </div>
            <div>
                <span class="text-secondary">Max Price: </span>
                <span class="price-range__max">BDT: {{ $max_price }}</span>
            </div>
            </div>
        </div>
        </div>
        ...
        <div class="swiper-slide">
            ...
            <div class="slide-split_text position-relative d-flex align-items-center"
                ...
                <h2
                    ...
                    Tailored <br /><strong>ARTISTRY</strong></h2>
                <p class="mb-0 animate animate_fade animate_btt animate_delay-5">Every piece of clothing is made with care. We mix traditional skills with modern styles to give you high-quality clothes that look great and feel comfortable.</h6>
                </div>
            </div>
            <div class="slide-split_media position-relative">
                <div class="slideshow-bg" style="background-color: #f5e6e0;">
                <img loading="lazy" src="assets/images/shop/shop_banner3.png" width="630" height="450"
                    alt="Men's accessories" class="slideshow-bg__img object-fit-cover" />
                </div>
            </div>
            </div>
        </div>
